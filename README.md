...
It scores each hour against British Skydiving's limits (Operations Manual, section 8): ground wind 15 kt for AFF and category students, 20 kt for 'A' licence and above and tandem students, with jumping suspended after two gusts over the limit; the ground must be visible from the exit point; flight visibility at least 5 km. Ground wind, wind at canopy height (2,500 ft), upper wind (10,000 ft), low cloud, mid cloud, rain and visibility each give a 0 to 1 chance and the hour's likelihood is their product. British Skydiving sets no figure for winds aloft; the app treats about 30 kt at 2,500 ft and about 50 kt at 10,000 ft as the point where a day usually gets called off. Broken or solid low cloud with a base under 3,500 ft is marked down further. 70% and up is Likely, 40 to 70% Marginal, below that Unlikely. A toggle switches between the 20 kt and 15 kt limits.
